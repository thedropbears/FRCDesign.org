...
=== "Imperial"
    ...
    ???+ Example "Box Tube Example"
        ...
        ![](/img/learning-course/stage1a/tube.webp)
        2x1 thinwall tube forming part of a robot structure. (Photo Credit: FRC 3647)

=== "Metric"

    In FRC, robot structures are typically constructed out of aluminum box tubing, similar to wood beams for a house. Aluminum box tubing is commonly found in 50x25mm, 25x25mm, and 50x50mm sizes with 3mm (thickwall) or 1.6mm (thinwall) wall thicknesses. Box tubing is typically referred to by its size, eg: 50x25, 25x25, and 50x50 (Spoken as "fifty-by-twenty-five", "twenty-five-by-twenty-five", and "fifty-by-fifty"). For the rest of the learning course, we will use this notation when referring to box tube.

    ???+ Example "Box Tube Example"

        ![](/img/learning-course/stage1a/tube.webp)
        Thinwall tube forming part of a robot structure. (Photo Credit: FRC 3647)
...
=== "Metric"
    ...
    === "0"
          ![](/img/learning-course/stage1a/exercises/e1/e1s0.webp)
          The final part.

    === "1"
          ![](/img/learning-course/stage1a/exercises/e1/e1s1.webp)
          Start by sketching a center rectangle on the top plane. Notice that we put the origin of the part at the center of the tube so that we can leverage the default geometry later on.

    === "2"
          ![](/img/learning-course/stage1a/exercises/e1/e1s2.webp)
          Extrude the rectangle symmetrically, 2" tall.

    === "3"
          ![type:video](/img/learning-course/stage1a/exercises/e1/e1s3.webm)
          Shell the block to turn it into a 1/16" wall tube.

    === "4"
          ![type:video](/img/learning-course/stage1a/exercises/e1/e1s4.webm)
          Add the top holes. Set the centerpoint of the hole to be vertical with the midpoint of the bottom line, then Mirror the hole across, using the front plane as the mirror line. We are able to use the front plane to mirror since we intelligently placed the origin at the center of the tube in step 1.

    === "5"
          ![type:video](/img/learning-course/stage1a/exercises/e1/e1s5.webm)
          Extrude the top holes to cut all the way through the tube.

    === "6"
          ![type:video](/img/learning-course/stage1a/exercises/e1/e1s6.webm)
          Add the side holes. Create the layout for the side holes by creating a center point rectangle and turning it into construction geometry. Again, having the origin at the center of the tube lets us place the center of the pattern at the center of the tube.

    === "7"
          ![](/img/learning-course/stage1a/exercises/e1/e1s7.webp)
          Extrude the side holes to cut all the way through the tube.

    === "8"
          ![type:video](/img/learning-course/stage1a/exercises/e1/e1s8.webm)
          Name the key sketches and part. You can set part appearances and materials by right clicking on the part instance. Set the material to be 6061 Aluminum. To see the mass of parts, use the <code>Display Mass Properties</code> Menu
